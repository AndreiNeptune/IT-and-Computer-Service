...
export default function Gallery() {
  ...
  return (
    <section id="gallery" className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-50 dark:bg-slate-900/50 transition-colors border-b border-slate-100 dark:border-slate-900">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="max-w-4xl mx-auto mt-16 p-6 sm:p-8 bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-sm text-slate-600 dark:text-slate-300 text-sm sm:text-base leading-relaxed space-y-4">
          ...
          <div className="flex gap-3 items-start pt-3 border-t border-slate-100 dark:border-slate-900">
            ...
            <p>
              Sau, dimpotrivă, ceea ce pare a fi o problemă software este cauzată de funcționarea defectuoasă a memoriilor RAM, a unui hard disk obosit sau a supraîncălzirii. La <strong>COMPUTER SHOP &amp; SERVICE</strong>, diagnoza corectă făcută din start te scutește de timp și bani aruncați inutil pe piese.
            </p>
          </div>
        </div>
