...
export default function ContactForm() {
  ...
  const commonServices = [
    ...
    "Reparație Placă de Bază / Micro-soldering",
    "Înlocuire Display Laptop",
    "Înlocuire Baterie / Tastatură",
    "Upgrade SSD / Memorie RAM",
    "Asamblare Calculator Gaming / Office",
    "Recuperare Date Pierdute",
    "Alt Serviciu (Detaliez în mesaj)",
  ];

  return (
    <section id="contact" className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-50 dark:bg-slate-900/30 transition-colors">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14">
          ...
          <h3 className="text-3xl sm:text-4xl font-extrabold text-slate-900 dark:text-white tracking-tight mb-4">
            Trimite o solicitare de reparație
          </h3>
