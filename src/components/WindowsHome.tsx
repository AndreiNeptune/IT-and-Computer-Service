...
export default function WindowsHome() {
  ...
  return (
    <section id="windows-home" className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-900 text-white relative overflow-hidden transition-colors border-y border-slate-800">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg sm:text-xl text-slate-300 font-bold mb-4">
        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-stretch">
          ...
          <motion.div
            ...
            className="lg:col-span-6 bg-slate-950/70 border border-slate-800 rounded-2xl p-6 sm:p-8 flex flex-col justify-between shadow-2xl relative"
          >
          ...
          >
            <div className="bg-slate-950/40 border border-slate-800/80 rounded-2xl p-6 sm:p-8">
            ...
            {/* Prompt warning card */}
            <div className="bg-gradient-to-r from-blue-950/40 to-indigo-950/40 border border-blue-900/40 rounded-2xl p-6 sm:p-8 flex flex-col sm:flex-row items-center gap-4 sm:gap-6 shadow-lg">
              <div className="bg-blue-500/10 p-3.5 rounded-2xl text-blue-400 shrink-0 border border-blue-500/20">
                <ShieldCheck className="w-8 h-8" />
              </div>
              <div className="text-center sm:text-left">
                <h4 className="font-bold text-white text-base">Securitate și Stabilitate Garantate</h4>
