...
export default function Navbar() {
  ...
  return (
    <header className="w-full z-50">
      {/* Top Info Bar */}
      <div className="w-full bg-slate-900 text-slate-300 py-2.5 px-4 sm:px-6 lg:px-8 text-sm border-b border-slate-800 transition-colors">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-2">
          <div className="flex flex-wrap justify-center items-center gap-4">
            <a
              href="mailto:office@servicecomputer.ro"
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="hover:text-blue-500 transition-colors text-slate-300 hover:scale-110"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-pink-500 transition-colors text-slate-300 hover:scale-110"
                aria-label="Vizitează profilul nostru de Instagram"
              >
                <svg className="w-4.5 h-4.5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <nav
        className={`w-full transition-all duration-300 ${
          isScrolled
            ? "sticky top-0 bg-white/95 dark:bg-slate-950/95 shadow-md backdrop-blur-md py-3"
            : "relative bg-white dark:bg-slate-950 py-4"
