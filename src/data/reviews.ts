...
export const reviewsData: ReviewItem[] = [
  {
    ...
    rating: 5,
    text: "Mi-ați făcut mentenanța la laptop și temperatura acum este foarte OK. Un laptop Asus. Foarte buni și ieftini, multumesc Computer SHOP Service laptop!",
    device: "Laptop Asus",
